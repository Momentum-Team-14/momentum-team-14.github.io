...
Sign up for this practice site:[Exercism](https://exercism.io/).
...
Please complete the [Python section](https://momentumlearn.thinkific.com/courses/take/back-end-development-with-python-and-django/) through "More iterating with Python" by Wednesday morning, 8/10.  
